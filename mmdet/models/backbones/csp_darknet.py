...
class Focus(nn.Module):
    ...
    def __init__(self,
        ...
        super().__init__()
        self.conv = ConvModule(in_channels * 4,
                               out_channels,
                               kernel_size,
                               stride,
...
class CSPDarknet(BaseModule):
    ...
    arch_settings = {
        'P5': [[64, 128, 3, True, False], [128, 256, 9, True, False], [256, 512, 9, True, False],
               [512, 1024, 3, False, True]],
        'P6': [[64, 128, 3, True, False], [128, 256, 9, True, False], [256, 512, 9, True, False],
               [512, 768, 3, True, False], [768, 1024, 3, False, True]]
    }
    ...
    def __init__(self,
        ...
        for i, (in_channels, out_channels, num_blocks, add_identity, use_spp) in enumerate(arch_setting):
            ...
            if use_spp:
                spp = SPPBottleneck(out_channels,
                                    out_channels,
