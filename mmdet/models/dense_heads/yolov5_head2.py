...
from .yolov5_head_inherit2 import YoloV5InheritHead
...
class YOLOV5Head2(YoloV5InheritHead):
    def _init_layers(self):
        ...
        self.head = nn.ModuleList(
            [nn.Conv2d(make_div_fun(256), 75, 1),
             nn.Conv2d(make_div_fun(512), 75, 1),
             nn.Conv2d(make_div_fun(1024), 75, 1)]
        )
