...
class YOLOXHead(BaseDenseHead, BBoxTestMixin):
    ...
    def forward(self, feats):
        ...
        return multi_apply(self.forward_single, feats, self.multi_level_cls_convs, self.multi_level_reg_convs,
    ...
    def loss(self, cls_scores, bbox_preds, objectnesses, gt_bboxes, gt_labels, img_metas, gt_bboxes_ignore=None):
        ...
        (pos_masks, cls_targets, obj_targets, bbox_targets,
         l1_targets, num_fg_imgs) = multi_apply(self._get_target_single, flatten_cls_preds.detach(),
    ...
    def _get_target_single(self, cls_preds, objectness, priors, decoded_bboxes, gt_bboxes, gt_labels):
        ...
        assign_result = self.assigner.assign(cls_preds.sigmoid() * objectness.unsqueeze(1).sigmoid(), offset_priors,
