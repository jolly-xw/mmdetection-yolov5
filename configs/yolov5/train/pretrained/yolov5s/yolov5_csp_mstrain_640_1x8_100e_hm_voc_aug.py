...
train_dataset = dict(
    ...
    dataset=dict(
        type='VOCDataset',
        ann_file='../datasets/hm/VOCdevkit/VOC2007/ImageSets/Main/train.txt',
        img_prefix='../datasets/hm/VOCdevkit/VOC2007/',
        pipeline=[
            dict(type='LoadImageFromFile'),
...
data = dict(
    ...
    val=dict(
        type='VOCDataset',
        ann_file='../datasets/hm/VOCdevkit/VOC2007/ImageSets/Main/val.txt',
        img_prefix='../datasets/hm/VOCdevkit/VOC2007/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
