...
model = dict(type='YOLOV5',
             ...
             backbone=dict(type='CSPDarknetV5', 
                           deepen_factor=0.33, 
                           widen_factor=0.5,
                           init_cfg=dict(type='Pretrained', checkpoint='model_tools/prepare_pretrained_model/pretrained_model/csp_darknet5.pth')),
