...
data_root = '/home/wx/git/beifen/data_single/data/VOCdevkit/'
...
data = dict(
    ...
    train=dict(
        ...
        pipeline=[
            ...
            dict(type='YOLOV5RandomPerspective',degrees=0.0,translate=0.1,scale=0.5,shear=0.0),
            dict(type='Normalize', mean=[0, 0, 0], std=[255.0, 255.0, 255.0], to_rgb=True),
...
# load_from = 'model_tools/mm_model/ori_missile_mm.pth'
